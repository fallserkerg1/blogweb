...
<div class="container-fluid">
    <div class="container">
        ...
        <!-- <a href=" {{ route('admin.categories.create') }}" class="btn btn-primary" style="float: right; margin: 15px;">New Category</a> -->
        <!-- Button trigger modal -->
        ...
        <table class="table">
            ...
            @foreach($dato as $category)
            <tbody>
                <tr>
                <td style="text-align: center">{{ $category->name }}</td>
                <td style="text-align: center">{{ $category->slug }}</td>
                <td style="text-align: center">
                    <a href="{{ route('admin.categories.edit', $category) }}" class="btn btn-success" style="margin: 5px"><i class="fas fa-edit"></i></a>
                    <!-- Button trigger modal -->
